...
namespace Moneta {
    ...
    public partial class mydbDataSet2 : global::System.Data.DataSet {
        ...
        public partial class invoicesDataTable : global::System.Data.TypedTableBase<invoicesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public invoicesRow AddinvoicesRow(System.DateTime Date, int Clients_ClientID, string Type, string Paid) {
        ...
        public partial class invoicesRow : global::System.Data.DataRow {
            ...
            public string Type {
                get {
                    return ((string)(this[this.tableinvoices.TypeColumn]));
                }
                set {
                    this[this.tableinvoices.TypeColumn] = value;
                }
            }
            ...
            public string Paid {
                get {
                    return ((string)(this[this.tableinvoices.PaidColumn]));
                }
                set {
...
namespace Moneta.mydbDataSet2TableAdapters {
    ...
    public partial class invoicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `invoices` WHERE ((`InvoiceID` = @p1) AND (`Date` = @p2) AND (`Client" +
                "s_ClientID` = @p3) AND (`Type` = @p4) AND (`Paid` = @p5))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `invoices` (`Date`, `Clients_ClientID`, `Type`, `Paid`) VALUES (@p1, " +
                "@p2, @p3, @p4)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `invoices` SET `Date` = @p1, `Clients_ClientID` = @p2, `Type` = @p3, `Paid" +
                "` = @p4 WHERE ((`InvoiceID` = @p5) AND (`Date` = @p6) AND (`Clients_ClientID` = " +
                "@p7) AND (`Type` = @p8) AND (`Paid` = @p9))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `InvoiceID`, `Date`, `Clients_ClientID`, `Type`, `Paid` FROM `invoices`";
        ...
        public virtual int Fill(mydbDataSet2.invoicesDataTable dataTable) {
        ...
        public virtual mydbDataSet2.invoicesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mydbDataSet2.invoicesDataTable dataTable = new mydbDataSet2.invoicesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mydbDataSet2.invoicesDataTable dataTable) {
        ...
        public virtual int Delete(int p1, System.DateTime p2, int p3, string p4, string p5) {
        ...
        public virtual int Update(System.DateTime p1, int p2, string p3, string p4, int p5, System.DateTime p6, int p7, string p8, string p9) {
